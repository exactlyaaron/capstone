...
window.tomahkAPI = {
    ...
    Track: function(title, artist, options) {
        ...
        var generateUrl = function() {
            return window.tomahkAPI.server+"/embed.php?artist="+encodeURIComponent(artist)+"&title="+encodeURIComponent(title)+"&disabled="+Obj.config.disabledResolvers.join(",")+"&autoplay="+Obj.config.autoplay;
        }
